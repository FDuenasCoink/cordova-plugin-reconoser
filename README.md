...
authToken=jp_lbmgq12uup81hiome66a5tkbjp
```

## Paso 2:

Modificar el archivo **android/build.gradle** o **build.gradle (Project: android)** con la configuración de maven de la siguiente manera:
...
dependencies {
    ...
    // SDK ReconoSer
    implementation 'org.bitbucket.reconoser_id:sdk_android:1.5.1-alpha1' // Esta línea
}
```
...
public class App extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        LibraryReconoSer.init(this, getApplicationContext(), "BFA3AB5F-BAEB-42DE-986E-0DA98F45F90F", ""); // Esta línea
    }
}
```
