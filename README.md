...
Clonar el proyecto de Ionic: `git clone https://bitbucket.org/reconoser/reconoser-ionic.git `
Seleccionar proyecto: `cd reconoSer-ionic/`
...
> Cambia el package `import android.support.annotation.RequiresApi;` por `import androidx.annotation.RequiresApi;` y repita el Paso 11
...
Actualizar la versión de Swift
...
* The sandbox is not in sync with the Podfile.lock. Run 'pod install' or update your CocoaPods installation. / Podfile.lock: No such file or directory
> https://github.com/phonegap/phonegap-plugin-push/issues/2193#issuecomment-424858312

* No such module 'ReconoSerOlimpia'
> Remueve los Pods, Podfile.lock y ReconoSer.xcworkspace. Luego instala los Pods y abre el proyecto. Este proceso en ocasiones toca realizarlos varias veces hasta que el proceso sincronice los Pods bien
